      ...
      {items.map(item => (
        ...
        <div className="flex justify-between" key={item.card.info.id}>
          ...
          <div className="relative w-36 h-36 mb-12">
            ...
            <button className="absolute bottom-0 left-1/2  transform -translate-x-1/2 translate-y-3 p-1 shadow-lg w-16 rounded-lg text-slate-50 bg-slate-500">ADD</button>
          </div>
