...
let RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card w-60 h-[370] border-4 shadow-2xl border-black rounded-2xl  m-3 transition-transform duration-300 hover:scale-105 hover:rounded-2xl hover:shadow-black">
...
export const withPromotedLabel = (RestaurantCard) => {
    return (props) => {
        return (
            <div> 
                <label className="absolute mt-1 w-24 rounded-xl justify-center text-center  ml-3 bg-slate-500   ">Promoted</label>
